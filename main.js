...
function horizontal_bar_chart(element, data) {
    $("#" + element).html("");
...
$(function () {
    ...
    var URLGaming ="emojis_freq.csv";

    d3.csv(URLGaming, function (d) {
        data = d;
